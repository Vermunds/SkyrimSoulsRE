		...
		case RE::UI_MESSAGE_TYPE::kShow:
			{
				...
				if (!this->uiMovie)
				{
					SKSE::log::error("Broken HUD Menu! uiMovie is null, possibly because its SWF file failed to load. Skipping HUD modifications.");
					break;
				}
				...
				if (!this->uiMovie->GetVariable(&stealthMeter, "_root.HUDMovieBaseInstance.StealthMeterInstance") || !stealthMeter.IsObject())
				{
					...
					SKSE::log::error("Incompatible HUD Menu! StealthMeterInstance not found. Disabling HUD modifications for current session.");
					break;
				}
				...
				{
					SKSE::log::warn("Incompatible HUD Menu! SneakTextClip not found. Skipping its modifications.");
					break;
				}
				...
				{
					SKSE::log::warn("Incompatible HUD Menu! SneakTextInstance not found. Skipping its modifications.");
					break;
				}
